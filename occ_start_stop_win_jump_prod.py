...
#-------------------------------------------------------------------------
#
# Script:       /home/opc/scripts/occ_start_stop_win_jump_prod.py
#
# Purpose:      Start and stop OCC Windows Jump server
#
...
#               /home/opc/.oci/config
#
# Usage:        /home/opc/scripts/occ_start_stop_win_jump_prod.py [start | stop] [fullpath_filename_to_windows_server_list]
#
# Log:          /home/opc/logs/occ_start_stop_win_jump_prod.log
#
# Revision History:
# Date          Author          Remarks
# 20250210      TE              original version
#
#-------------------------------------------------------------------------
...
logfile = "/home/opc/logs/" + filename[-1]  + ".log"
